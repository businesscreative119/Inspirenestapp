...
<div class="container mx-auto text-center py-10">
    ...
    <div class="flex justify-center space-x-4 overflow-x-auto px-4">
      <!-- Example Image Cards -->
      <<div id="section1" class="flex flex-col space-y-4 animate  animate">
      ...
      <div id="section2" class="flex flex-col space-y-4 animate mt-20  animate">
      ...
      <div id="section3" class="flex flex-col space-y-4 animate mt-32  animate">
      ...
      <div id="section4" class="flex flex-col space-y-4 animate mt-20  animate">
