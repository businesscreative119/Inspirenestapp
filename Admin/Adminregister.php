...
<body>
        <?php 
         ...
         if(mysqli_num_rows($verify_query) !=0 ){
            ...
            mysqli_query($con,"INSERT INTO `Admin`(Username,Email,Age,Password) VALUES('$username','$email','$age','$password')") or die("Erroe Occured");
...
<div class="w-full min-h-screen bg-zinc-300 flex items-center justify-center">
  <div class="w-full max-w-lg bg-zinc-100 px-10 py-8 rounded-2xl">
    <h1 class="text-3xl font-bold text-[#FF1D8D] text-center mb-6">AdminRegister</h1>
